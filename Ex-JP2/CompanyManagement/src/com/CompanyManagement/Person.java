...
class FPTDirector extends Person{
    ...
    public void input() {
        Scanner scanner = new Scanner(System.in);
        System.out.println("Khoi tao giam doc cua FPT");
        System.out.print("Nhap ten: ");
        name = scanner.nextLine();
        System.out.print("Nhap luong co ban: $");
        salary = Double.parseDouble(scanner.nextLine());
    ...
    @Override
    public void display() {
        System.out.printf("Giam doc FPT [id = %d, ten = %s, chuc vu = %s, luong co ban = $%.3f, muc thuong = $%.3f, tong luong = $%.3f ]%n", getId(), getName(), role, getSalary(), getBonus(), getTotalSalary());
    }
...
class FPTEmployee extends Person {
    ...
    public void input() {
        Scanner scanner = new Scanner(System.in);
        System.out.println("Dang khoi tao nhan vien cua FPT");
        System.out.println("Nhap ten: ");
        name = scanner.nextLine();
        System.out.println("Nhap luong co ban: $");
        salary = Double.parseDouble(scanner.nextLine());
    ...
    @Override
    public void display() {
        System.out.printf("Nhan vien FPT [ id = %d, ten = %s, skill = %s, luong co ban = $%.3f, muc thuong = $%.3f, tong luong = $%.3f ]%n", getId(), getName(), skill, getSalary(), getBonus(), getTotalSalary());
...
class FPTManager extends Person {
    ...
    public void input() {
        Scanner scanner = new Scanner(System.in);
        System.out.println("Dang khoi tao truong phong cua FPT");
        System.out.println("Nhap ten: ");
        name = scanner.nextLine();
        System.out.println("Nhap luong co ban: $");
        salary = Double.parseDouble(scanner.nextLine());
    ...
    @Override
    public void display() {
        System.out.printf("Truong phong FPT [ id = %d, ten = %s, phong ban = %s, luong co ban = $%.3f, muc thuong = $%.3f, tong luong = $%.3f ]%n", getId(), getName(), department, getSalary(), getBonus(), getTotalSalary());
    }
